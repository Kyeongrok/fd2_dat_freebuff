/*
 * func-name: sub_38F2B
 * func-address: 0x38f2b
 * callers: 0x41300, 0x41380, 0x44180, 0x44200
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x3f950
 */

void __usercall sub_38F2B(int a1@<eax>, int a2, int a3)
{
  int v3; // edx
  int v5; // eax
  ...
  if ( dword_54174 && (v3 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_install_driver(0x%X,%u)\n", a2, a3);
  v5 = sub_3F950(a2, a3);

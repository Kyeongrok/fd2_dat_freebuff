/*
 * func-name: sub_3A0A2
 * func-address: 0x3a0a2
 * callers: none
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x418b0
 */

void __usercall sub_3A0A2(int a1@<eax>, int a2, int a3, int a4)
{
  int v4; // edx
  int v6; // eax
  ...
  if ( dword_54174 && (v4 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_minimum_sample_buffer_size(0x%X,%d,%d)\n", a2, a3, a4);
  v6 = sub_418B0(a2, a3, a4);

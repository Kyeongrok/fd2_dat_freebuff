/*
 * func-name: sub_3C378
 * func-address: 0x3c378
 * callers: none
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x44ed0
 */

void __usercall sub_3C378(int a1@<eax>, int a2, int a3)
{
  int v3; // edx
  int v5; // eax
  ...
  if ( dword_54174 && (v3 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_sequence_user_data(0x%X,%u)\n", a2, a3);
  v5 = sub_44ED0(a2, a3);

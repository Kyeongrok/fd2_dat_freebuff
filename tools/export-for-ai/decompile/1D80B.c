...
int __fastcall sub_1D80B(__int32 a1, int a2, int a3, int a4)
{
  ...
  for ( n6 = 0; n6 < n6_0; ++n6 )
  {
    n6_5 = 0;
    sub_4E381();
    v6 = (_BYTE *)(dword_53A45 + 80 * n6);
    n255 = 255;
    if ( v6[6] == 1 && (v6[5] & 0x81) == 0 && !v6[38] )
      sub_13A9F(n6, 1);
    if ( n255 != 255 )

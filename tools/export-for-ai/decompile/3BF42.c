/*
 * func-name: sub_3BF42
 * func-address: 0x3bf42
 * callers: none
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x44e30
 */

void __usercall sub_3BF42(int a1@<eax>, int a2, int a3)
{
  int v3; // edx
  int v5; // eax
  ...
  if ( dword_54174 && (v3 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_register_trigger_callback(0x%X,0x%X)\n", a2, a3);
  v5 = sub_44E30(a2, a3);

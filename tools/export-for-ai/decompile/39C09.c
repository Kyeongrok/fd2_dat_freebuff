/*
 * func-name: sub_39C09
 * func-address: 0x39c09
 * callers: none
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x41600
 */

void __fastcall sub_39C09(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // edx
  int v7; // eax
  ...
  if ( dword_54174 && (v5 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_sample_playback_rate(0x%X)\n", a5);
  v7 = sub_41600(a5);

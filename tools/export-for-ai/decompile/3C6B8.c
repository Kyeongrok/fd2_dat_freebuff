/*
 * func-name: sub_3C6B8
 * func-address: 0x3c6b8
 * callers: none
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x45220
 */

void __usercall sub_3C6B8(int a1@<eax>, int a2, int a3)
{
  int v3; // edx
  int v5; // eax
  ...
  if ( dword_54174 && (v3 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_true_sequence_channel(0x%X,%d)\n", a2, a3);
  v5 = sub_45220(a2, a3);

/*
 * func-name: sub_38E46
 * func-address: 0x38e46
 * callers: 0x40cf0, 0x43ad0
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x3fc33
 */

void __fastcall sub_38E46(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // edx
  int v7; // eax
  ...
  if ( dword_54174 && (v5 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_get_IO_environment(0x%X)\n", a5);
  v7 = sub_3FC33(a5);

/*
 * func-name: sub_39176
 * func-address: 0x39176
 * callers: 0x413c0
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x41300
 */

void __usercall sub_39176(int a1@<eax>, const char *a2, int a3)
{
  int v3; // edx
  int v5; // eax
  ...
  if ( dword_54174 && (v3 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_install_DIG_driver_file(%s,0x%X)\n", a2, a3);
  v5 = sub_41300(a2, a3);

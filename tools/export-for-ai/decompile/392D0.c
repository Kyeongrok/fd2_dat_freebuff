/*
 * func-name: sub_392D0
 * func-address: 0x392d0
 * callers: 0x25bf4, 0x41ec1, 0x45e21
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x41460
 */

void __fastcall sub_392D0(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // edx
  int v7; // eax

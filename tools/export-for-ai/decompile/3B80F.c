/*
 * func-name: sub_3B80F
 * func-address: 0x3b80f
 * callers: none
 * callees: 0x37c9c, 0x3f22a, 0x3f46b, 0x44af0
 */

void __usercall sub_3B80F(int a1@<eax>, int a2, int a3, int a4)
{
  int v4; // edx
  int v6; // eax
  ...
  if ( dword_54174 && (v4 == 1 || dword_54170) && !sub_3F22A(a1) && sub_37C9C() )
    fprintf(env, "AIL_install_timbre(0x%X,%d,%d)\n", a2, a3, a4);
  v6 = sub_44AF0(a2, a3, a4);
